...
(function () {
  ...
  function buildNav(me) {
    ...
    nav.innerHTML = `
      <div class="snav-inner">
        ...
        <div class="snav-right">
          <button class="snav-icon-btn" id="snav-theme-btn" title="Toggle theme" type="button">☀️</button>
    ...
    document.getElementById("snav-theme-btn")?.addEventListener("click", () => {
      ...
      const btn = document.getElementById("snav-theme-btn");
      if (btn) btn.textContent = next === "light" ? "🌙" : "☀️";
      // Also update any standalone theme-toggle buttons on the page
    ...
    if (themeBtn) themeBtn.textContent = (localStorage.getItem("sanatioTheme")||"dark")==="light" ? "🌙" : "☀️";
